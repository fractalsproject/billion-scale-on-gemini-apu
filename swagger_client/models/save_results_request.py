...
class SaveResultsRequest(object):
    ...
    def directory_to_save_results(self):
        ...
        Path to a directory where results will be saved.  # noqa: E501
    ...
    def dataset_id(self):
        ...
        The dataset id which associated with the results. parameter will be used in order to save results in workspace only if directory_to_save_results parameter is empty.  # noqa: E501
