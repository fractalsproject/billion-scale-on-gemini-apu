...
class ImportDatasetRequest(object):
    ...
    def __init__(self, ds_file_path=None, ds_file_type=None, search_type='flat', train_ind=False, grid_train=False, train_config_file_path=None, target_accuracy=100, md_file_path=None, md_unique=False, convert_to_dataset=False):  # noqa: E501
