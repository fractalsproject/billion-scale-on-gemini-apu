...
class GetStatsResponse(object):
    ...
    def __init__(self, monitor_stats=None):  # noqa: E501
        """GetStatsResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def monitor_stats(self):
        """Gets the monitor_stats of this GetStatsResponse.  # noqa: E501


        :return: The monitor_stats of this GetStatsResponse.  # noqa: E501
        :rtype: list[object]
        """
        return self._monitor_stats

    @monitor_stats.setter
    def monitor_stats(self, monitor_stats):
        """Sets the monitor_stats of this GetStatsResponse.


        :param monitor_stats: The monitor_stats of this GetStatsResponse.  # noqa: E501
        :type: list[object]
        """

        self._monitor_stats = monitor_stats
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetStatsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetStatsResponse):
            return False
