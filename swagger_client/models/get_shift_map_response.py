...
class GetShiftMapResponse(object):
    ...
    def __init__(self, map=None):  # noqa: E501
        """GetShiftMapResponse - a model defined in Swagger"""  # noqa: E501
        self._map = None
    ...
    @property
    def map(self):
        """Gets the map of this GetShiftMapResponse.  # noqa: E501

        String in form of JSON represeting the shifts of records due to add/remove actions the key number is the old location , the value number is the replaced index  # noqa: E501

        :return: The map of this GetShiftMapResponse.  # noqa: E501
        :rtype: str
        """
        return self._map
    ...
    @map.setter
    def map(self, map):
        """Sets the map of this GetShiftMapResponse.

        String in form of JSON represeting the shifts of records due to add/remove actions the key number is the old location , the value number is the replaced index  # noqa: E501

        :param map: The map of this GetShiftMapResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetShiftMapResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetShiftMapResponse):
            return False
