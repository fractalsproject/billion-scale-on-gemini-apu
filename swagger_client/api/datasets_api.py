...
class DatasetsApi(object):
    ...
    def apis_remove_metadata(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.apis_remove_metadata(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.apis_remove_metadata_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.apis_remove_metadata_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def apis_remove_metadata_with_http_info(self, body, **kwargs):  # noqa: E501
        """Remove data from a loaded dataset by index of metadata  # noqa: E501

        API will remove a record from a loaded dataset. The function will locate a metadata value by metadata file - which is unique and it will fail incase it is not. If that metadata record is found, then it will remove the record based on its index  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.apis_remove_metadata_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method apis_remove_metadata" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `apis_remove_metadata`")  # noqa: E501
