...
class UtilitiesApi(object):
    ...
    def apis_clean_csv_result(self, dataset_id, num_of_files_to_keep, **kwargs):  # noqa: E501
        """Clean old CSV results  # noqa: E501

        Clean old CSV results.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.apis_clean_csv_result(dataset_id, num_of_files_to_keep, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.apis_clean_csv_result_with_http_info(dataset_id, num_of_files_to_keep, **kwargs)  # noqa: E501
        else:
            (data) = self.apis_clean_csv_result_with_http_info(dataset_id, num_of_files_to_keep, **kwargs)  # noqa: E501
            return data

    def apis_clean_csv_result_with_http_info(self, dataset_id, num_of_files_to_keep, **kwargs):  # noqa: E501
        """Clean old CSV results  # noqa: E501

        Clean old CSV results.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.apis_clean_csv_result_with_http_info(dataset_id, num_of_files_to_keep, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['dataset_id', 'num_of_files_to_keep']  # noqa: E501
        ...
        if ('dataset_id' not in params or
            ...
            raise ValueError("Missing the required parameter `dataset_id` when calling `apis_clean_csv_result`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/result/clean/{dataset_id}/{num_of_files_to_keep}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def apis_clear_cache(self, **kwargs):  # noqa: E501
        """Clear cache and restore workspace to its initial state  # noqa: E501

        Clear cache and restore workspace to its initial state  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.apis_clear_cache(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.apis_clear_cache_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.apis_clear_cache_with_http_info(**kwargs)  # noqa: E501
            return data

    def apis_clear_cache_with_http_info(self, **kwargs):  # noqa: E501
        """Clear cache and restore workspace to its initial state  # noqa: E501

        Clear cache and restore workspace to its initial state  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.apis_clear_cache_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method apis_clear_cache" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def apis_convert_txt_to_bin(self, body, **kwargs):  # noqa: E501
        """Parse and convert a text file into a indices file, binary records file and metadata file  # noqa: E501

        Parse and convert a text file into a indices file, binary records file and metadata file  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.apis_convert_txt_to_bin(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.apis_convert_txt_to_bin_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.apis_convert_txt_to_bin_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def apis_convert_txt_to_bin_with_http_info(self, body, **kwargs):  # noqa: E501
        """Parse and convert a text file into a indices file, binary records file and metadata file  # noqa: E501

        Parse and convert a text file into a indices file, binary records file and metadata file  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.apis_convert_txt_to_bin_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method apis_convert_txt_to_bin" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `apis_convert_txt_to_bin`")  # noqa: E501
    ...
    def apis_generate_metadata(self, body, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.apis_generate_metadata_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.apis_generate_metadata_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def apis_generate_metadata_with_http_info(self, body, **kwargs):  # noqa: E501
        """Generate random metadata  # noqa: E501

        Generates X (size argument) number of UID random records into a pkl file  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.apis_generate_metadata_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method apis_generate_metadata" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `apis_generate_metadata`")  # noqa: E501
    ...
    def apis_get_shiftmap(self, dataset_id, allocation_id, **kwargs):  # noqa: E501
        """Get shift maps  # noqa: E501

        API will return the shift map that is popualted part of add/remove APIs  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.apis_get_shiftmap(dataset_id, allocation_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: GetShiftMapResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.apis_get_shiftmap_with_http_info(dataset_id, allocation_id, **kwargs)  # noqa: E501
        else:
            (data) = self.apis_get_shiftmap_with_http_info(dataset_id, allocation_id, **kwargs)  # noqa: E501
            return data

    def apis_get_shiftmap_with_http_info(self, dataset_id, allocation_id, **kwargs):  # noqa: E501
        """Get shift maps  # noqa: E501

        API will return the shift map that is popualted part of add/remove APIs  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.apis_get_shiftmap_with_http_info(dataset_id, allocation_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['dataset_id', 'allocation_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method apis_get_shiftmap" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'dataset_id' is set
        if ('dataset_id' not in params or
                params['dataset_id'] is None):
            raise ValueError("Missing the required parameter `dataset_id` when calling `apis_get_shiftmap`")  # noqa: E501
        # verify the required parameter 'allocation_id' is set
        if ('allocation_id' not in params or
                params['allocation_id'] is None):
            raise ValueError("Missing the required parameter `allocation_id` when calling `apis_get_shiftmap`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/dataset/shiftmap/get/{allocation_id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='GetShiftMapResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
